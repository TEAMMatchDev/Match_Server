...
public class OrderConvertor {
    ...
    public DonationUser donationBillUser(NiceBillOkResponse niceBillOkResponse, Long id, int amount, Long projectId, String flameName, String inherenceNumber, RegularStatus regularStatus, Long regularPaymentId) {
        return DonationUser.builder()
                .userId(id)
                .projectId(projectId)
                .price(amount)
