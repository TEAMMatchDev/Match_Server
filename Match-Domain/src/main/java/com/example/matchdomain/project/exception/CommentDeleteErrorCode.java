...
@Getter
@AllArgsConstructor
public enum CommentDeleteErrorCode implements BaseErrorCode {

    @ExplainError("해당 응원이 존재하지 않습니다.")
    COMMENT_NOT_EXIST(HttpStatus.BAD_REQUEST,false,"COMMENT001","해당 응원이 존재하지 않습니다."),
    @ExplainError("해당 응원 삭제권한이 없습니다.")
    COMMENT_DELETE_ERROR_CODE(HttpStatus.BAD_REQUEST,false,"COMMENT001","해당 응원 삭제권한이 없습니다.");
