...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        Server UbuntuServer = new Server("server", "https://dev.matchserver.shop", "for prod server", Collections.emptyList(), Collections.emptyList());
        Server ProdServer = new Server("server", "https://prod.matchserver.shop", "for dev server", Collections.emptyList(), Collections.emptyList());
