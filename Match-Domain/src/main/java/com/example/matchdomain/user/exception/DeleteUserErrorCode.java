...
@Getter
@AllArgsConstructor
public enum DeleteUserErrorCode implements BaseErrorCode {
    @ExplainError("애플 유저는 02-13 API 사용")
    APPLE_USER_NOT_API(BAD_REQUEST,"USER_DELETE_001","애플 유저는 02-13 API 사용");
