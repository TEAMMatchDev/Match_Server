...
@Getter
@AllArgsConstructor
public enum GetRegularErrorCode implements BaseErrorCode {
    @ExplainError("해당 정기 기부가 존재하지 않을때 나는 Error.")
    REGULAR_NOT_EXIST(BAD_REQUEST,"REGULAR001", "해당 정기 기부가 존재하지 않습니다.");
